...
public class ImporterTests
{
    ...
    public async Task Test1()
    {
        ...
        var access = new MusicianDataAccess(new ValueBasedOptionsMonitor<ConnectionStrings>(connection));
        var importer = new SetlistImporter(new NullLogger<SetlistImporter>(), access);
